...
public class SpawnConfig : ScriptableObject
{
    ...
    [Header("Visiteurs repas — flux de spawn indépendant du client chambre")]
    [Tooltip("Intervalle en secondes entre deux spawns de visiteur repas (si MonsterData.mealVisitorSpawnInterval = 0). " +
             "Valeur de départ — à toi d'ajuster. Tourne en parallèle du spawn client chambre, pas un ratio partagé.")]
    public float defaultMealVisitorSpawnInterval = 30f;
